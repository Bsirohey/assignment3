...
export default function Footer() {
  return (
    <div>
      <div class="mt-5 pt-5">
        <hr style={{ color: "white", border: "1px" }}></hr>
      </div>

      <div class="container-fluid">
        <h4 class="font-weight-bold text-white mx-3 mt-3">Browse By Link</h4>
        <div class="row px-4">
      ...
      <div class="globalFooter">
        ...
        <div class="container-fluid">
          <div class="row px-4">
            <div class="col-md-2 col-sm-auto">
              <ul class="list-group my-3">
                <h2 class="footerHeader">Solutions</h2>
                <ul class="py-2">
                  <li>
            ...
            <div class="col-md-2 col-sm-auto">
              <ul class="list-group my-3">
                <h2 class="footerHeader">Platform</h2>
                <ul class="py-2">
                  <li>
            ...
            <div class="col-md-2 col-sm-auto">
              <ul class="list-group my-3">
                <h2 class="footerHeader">RESOURCES</h2>
                <ul class="py-2">
                  <li>
        ...
        <div class="container">
          <div>
            <div style={{ marginBottom: "30px" }}>
              <img
                src="https://www.pluralsight.com/content/dam/pluralsight2/icons/globe-white.png"
                alt="Globe wireframe"
              />
              <ul class="languages">
                <li class="language">
        ...
        <hr class="container" style={{ color: "white", border: "1px" }}></hr>
          ...
          <div class="row">
            <div class="footer-bottom-left">
              <a class="logo-link">
                <img
                  class="logo"
                  src="https://www.pluralsight.com/content/dam/pluralsight2/general/icons/light/ps-icon.png"
                />
              </a>
